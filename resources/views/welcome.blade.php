...
<head>
    ...
    @else
        <style>
            ...
            {{-- minified CSS omitted for brevity, keep your original here --}}
        </style>
    @endif
</head>
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                ...
                <ul class="flex gap-3 text-sm leading-normal flex-wrap">
                    ...
                    <li>
                        <a href="{{ route('blood.stock.public') }}"
                        class="inline-block bg-sky-500 hover:bg-sky-600 px-5 py-2 rounded-md text-white font-bold shadow transition">
                            🩸 See Blood Inventory
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('login') }}"
                        class="inline-block bg-gray-800 hover:bg-black px-5 py-2 rounded-md text-white font-bold shadow transition">
                            Login
                        </a>
                    </li>
                    ...
                    @if (Route::has('register'))
                        <li>
                            <a href="{{ route('register') }}"
                            class="inline-block bg-green-600 hover:bg-green-700 px-5 py-2 rounded-md text-white font-bold shadow transition">
                                Register
                            </a>
                        </li>
                    @endif
            ...
            <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                ...
                <svg class="w-[448px] max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] dark:hidden"
                    ...
                    {{-- SVG paths omitted for brevity — keep your originals here --}}
                </svg>
