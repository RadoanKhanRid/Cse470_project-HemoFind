                            ...
                            <tr style="border-bottom: 1px solid #f3f4f6;">
                                ...
                                <td style="padding: 12px; text-align: center;">
                                    <div style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                        ...
                                        @else
                                            <span style="color: #9ca3af; font-size: 12px; font-style: italic;">No GPS</span>
                                        @endif

                                        <form action="{{ route('blood.requests.complete', $request->id) }}" method="POST" onsubmit="return confirm('Mark as done?')">
                                            @csrf
                                            <button type="submit" 
                                                    style="background-color: #059669; color: white; padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: bold; border: none; cursor: pointer;">
                                                ✅ Done
                                            </button>
                                        </form>
                                    </div>
